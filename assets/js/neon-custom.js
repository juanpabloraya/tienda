...
;(function($, window, undefined){
	...
	$(document).ready(function()
	{
        ...
        {
            $(".autocompletar_ci").autocomplete({
    			source: 'vista/persona/buscar_persona.php',
                select: function(event, ui){
                            $("#id_persona").val(ui.item.id_persona);
                            $("#ci_expedido").val(ui.item.ci_expedido);
                            ...
                            $("#localidad_nacimiento").val(ui.item.localidad_nacimiento);
                            $("#provincia_nacimiento").val(ui.item.provincia_nacimiento);
                            $("#departamento_nacimiento").val(ui.item.departamento_nacimiento);
                            $("#localidad_residencia").val(ui.item.localidad_residencia);
                            $("#provincia_residencia").val(ui.item.provincia_residencia);
                            $("#departamento_residencia").val(ui.item.departamento_residencia);
                            $("#correo_persona").val(ui.item.correo_persona);
                            $("#telefono").val(ui.item.telefono);
                            $("#celular").val(ui.item.celular);
                            $("#direccion").val(ui.item.direccion);
                            $("#persona_referencia").val(ui.item.persona_referencia);
                            $("#telefono_referencia").val(ui.item.telefono_referencia);                                                    
                        }
    		});
            
            $(".autocompletar_ci_evaluado").autocomplete({
    			source: 'vista/evaluado/buscar_persona.php',
                select: function(event, ui){
                            $("#id_persona").val(ui.item.id_persona);
                            $("#ci_expedido").val(ui.item.ci_expedido);
                            $("#nombre_evaluado").val(ui.item.nombre_evaluado);
                            $("#apellido_paterno").val(ui.item.apellido_paterno);
                            $("#apellido_materno").val(ui.item.apellido_materno);
            ...
            $(".autocompletar_producto").autocomplete({
    			source: 'vista/producto/buscar_ui.php',
                select: function(event, ui){
                            $("#id_producto").val(ui.item.id_producto);                        
                        }
    		});
            
            $(".autocompletar_producto_salida").autocomplete({
    			source: 'vista/salida_almacen/buscar_ui.php',
                select: function(event, ui){
                            $("#fk_id_producto").val(ui.item.id_producto);                        
                            $("#cantidad_disponible").val(ui.item.cantidad);
                            $("#precio_salida").val(ui.item.precio);
                        }
    		});
            
            $(".autocompletar_venta").autocomplete({
    			source: 'vista/venta/buscar.php',
                select: function(event, ui){
                            $("#fk_id_detallecompra").val(ui.item.id_detallecompra);
                            $("#fk_id_articulo").val(ui.item.id_articulo);
                            $("#saldo").val(ui.item.saldo);
                            $("#saldo_msg").html(ui.item.saldo);
                            $("#precio_venta").val(ui.item.precio_venta);
                            $("#cantidad").focus();
                        }
    		});
            
            $(".autocompletar_producto_pedido").autocomplete({
    			source: 'vista/pedido/buscar_ui.php',
                select: function(event, ui){                            
                            $("#id_producto").val(ui.item.id_producto);
                            $("#cantidad_disponible").val(ui.item.cantidad);
            ...
            $(".autocompletar_cliente").autocomplete({
    			source: 'vista/venta/buscar_cliente.php',
                select: function(event, ui){
                            $("#fk_id_cliente").val(ui.item.id_cliente);
                            $("#nombres").val(ui.item.nombres);
                            $("#ap_paterno").val(ui.item.ap_paterno);
                            $("#ap_materno").val(ui.item.ap_materno);
                            $("#telefono").val(ui.item.telefono);
                        }
    		});
            
            $(".autocompletar_laboratorio").autocomplete({
    			source: 'vista/compra/buscar_laboratorio.php',
                select: function(event, ui){
                            $("#id_laboratorio").val(ui.item.id_laboratorio);                                                
                        }
    		});
        }
		...
		// Form Validation $.isFunction($.fn.validate)
		if($.fn.validate){
    	    $(".validate_form_volver").validate({
    				onkeyup: false,
    				errorClass: 'error',
    				validClass: 'valid',                
    		...
    		$(".validate").validate({    		        
                ...
                $(".validate_edit").validate({
    				...
    				validClass: 'valid',                
                    submitHandler: function(form) {                    
                        jConfirm('Esta seguro de guardar las modificaciones?','Mensaje',function(resp){
        					if (resp){
                                show_loading_bar({
										pct: 50,
                                        delay: 5,
                                        before: function(pct)
										{
                    					    jQuery(form).ajaxSubmit(function(data){
                                                if(data.indexOf('Error')>=0)
                                                    ...
                                                    var mensaje = "Guardado con &eacute;xito.";
                ...
                $(".validate_self").validate({
    				onkeyup: false,
    				errorClass: 'error',
    				validClass: 'valid',                
                    submitHandler: function(form) {                    
                        jConfirm('Esta seguro de guardar la acci&oacute;n?','Mensaje',function(resp){
        					if (resp){
                                show_loading_bar({
										pct: 50,
                                        delay: 5,
                                        before: function(pct)
										{
                    					    jQuery(form).ajaxSubmit(function(data){
                                                if(data.indexOf('Error')>=0)
                                                    ...
                                                    var mensaje = "Completado con &eacute;xito.";
                ...
                $(".validate_pre").validate({
    				onkeyup: false,
    				errorClass: 'error',
    				validClass: 'valid',                
                    submitHandler: function(form) {                    
                        jConfirm('Esta seguro de enviar los datos llenados en el formulario?','Mensaje',function(resp){
        					if (resp){
                                show_loading_bar({
										pct: 50,
                                        delay: 5,
                                        before: function(pct)
										{
                    					    jQuery(form).ajaxSubmit(function(data){                                                
                                                ...
                                                jAlert(data,'Mensaje',function(){
                                                    ...
                                                    {
                                                        var new_window = window.open("vista/preinscripcion/imprimir_formulario.php",'Formulario de Preinscripción','height=800,width=1000');
                                                        window.location.href="preinscripcion.php";
                                                    }
                                                });
                                        ...
                                        before: function(pct)
										{
                    					    jQuery(form).ajaxSubmit(function(data){                                                
                                                ...
                                                jAlert(data,'Mensaje',function(){
                                                    ...
                                                    {
                                                        var new_window1 = window.open("vista/inscripcion/imprimir_formulario.php",'Formulario de Inscripción','height=800,width=1000');
                                                        var new_window2 = window.open("vista/inscripcion/imprimir_carta.php",'Solicitud de Inscripción','height=800,width=1000');
                                        ...
                                        before: function(pct)
										{
                    					    jQuery(form).ajaxSubmit(function(data){                                                
                                                ...
                                                jAlert(data,'Mensaje',function(){
                                                    ...
                                                    {
                                                        var new_window1 = window.open("vista/inscripcion/imprimir_formulario_dip.php",'Formulario de Inscripción','height=800,width=1000');
                                                        var new_window2 = window.open("vista/inscripcion/imprimir_carta_dip.php",'Solicitud de Inscripción','height=800,width=1000');
                                                        
                                                        window.location.href="inscripcion_dip.php";
                                                    }
                                                });
                    					    ...
                    					    jQuery(form).ajaxSubmit(function(data){                                                
                                                ...
                                                jAlert(data,'Mensaje',function(){
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        window.location.href="inscripcion_diplomado.php";
                                                    }
                                                });
                                        ...
                                        before: function(pct)
										{
                    					    jQuery(form).ajaxSubmit(function(data){                                                
                                                ...
                                                jAlert(data,'Mensaje',function(){
                                                    ...
                                                    {
                                                        var new_window1 = window.open("vista/inscripcion/imprimir_formulario_curso.php",'Formulario de Inscripción','height=800,width=1000');
                                                        window.location.href="inscripcion_curso.php";
                                                    }
                                                });
        ...
        //
        $(".form_self").ajaxForm(function(data){
            if(data.indexOf('Error')>=0)
                var mensaje = "Ocurrión un error.";
            else
                var mensaje = "Completado con &eacute;xito.";
        ...
        $("#frm_verificar_inscripcion").ajaxForm(function(data){            
            jAlert(data,'Mensaje',function(){
                if(data.indexOf('Error')>=0)
                {
                    //error
                ...
                {
                    var ci = $("#ci").val();
                    var n_deposito = $("#n_deposito").val();
                    
                    $.post("formulario_inscripcion.php",{ci:ci, n_deposito:n_deposito},function(data){
                        $("#formulario_inscripcion").html(data);
                    });
        ...
        $("#frm_verificar_inscripcion_dip").ajaxForm(function(data){            
            jAlert(data,'Mensaje',function(){
                if(data.indexOf('Error')>=0)
                {
                    //error
                ...
                else
                {
                    ...
                    $.post("formulario_inscripcion_dip.php",{ci:ci, n_deposito:n_deposito},function(data){
                        $("#formulario_inscripcion").html(data);
                    });
        ...
        $("#frm_verificar_inscripcion_dip2").ajaxForm(function(data){            
            jAlert(data,'Mensaje',function(){
                if(data.indexOf('Error')>=0)
                {
                    //error
                ...
                else
                {
                    ...
                    $.post("formulario_inscripcion_dip2.php",{ci:ci, n_deposito:n_deposito},function(data){
                        $("#formulario_inscripcion").html(data);
                    });                 
                }
            });
        ...
        $("#frm_verificar_inscripcion_curso").ajaxForm(function(data){            
            jAlert(data,'Mensaje',function(){
                if(data.indexOf('Error')>=0)
                {
                    //error
                ...
                else
                {
                    ...
                    $.post("formulario_inscripcion_curso.php",{ci:ci, n_deposito:n_deposito},function(data){
                        $("#formulario_inscripcion").html(data);
                    });                 
                }
            });
