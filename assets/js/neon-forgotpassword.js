			...
			submitHandler: function(ev)
			{
				...
				neonForgotPassword.setPercentage(30, function()
				{
					...
					neonForgotPassword.setPercentage(98, function()
					{
						...
						$.ajax({
							url: baseurl + 'control/sesion/recuperar_pass.php',
							method: 'POST',
							dataType: 'json',
							data: {
							...
							success: function(response)
							{
                                ...
                                var mensaje = response.submitted_data.mensaje;																
								...
								setTimeout(function()
								{
                                    ...
                                    $(".form-forgotpassword-success").css('display', 'none');
                                    $(".form-forgotpassword-failed").css('display', 'none');
                                    ...
                                    {
                                        $(".form-forgotpassword-failed").slideDown('normal');
                                    }
