...
<style type="text/css">
<!--
    table.page_header {width: 100%; border: none; background-color: #DFF2FD; border-bottom: solid 1mm #316996; padding: 2mm }
    table.page_footer {width: 100%; border: none; background-color: #DFF2FD; border-top: solid 1mm #316996; padding: 2mm}
    h1 {color: #316996}
    h2 {color: #316996}
    h3 {color: #316996}
...
<?php
    ...
    try
    {
        ...
        $html2pdf->createIndex('Indice', 25, 12, false, true, 1);
