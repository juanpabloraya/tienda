...
?>
<h2>Asignar descuento a categoria</h2>
                      <br />
	...
	<div class="panel-body">
		<form name="frm_categoria_descuento" id="frm_categoria_descuento" action="control/categoria_descuento/insertar_categoria_descuento.php" method="post" role="form" class="validate form-horizontal form-groups-bordered">
